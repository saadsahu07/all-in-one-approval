...
export const Route = createFileRoute("/privacy-policy")({
  head: () => ({ meta: [
    { title: "Privacy Policy — ToolsHive" },
...
function PrivacyPage() {
  return (
    <article className="mx-auto max-w-3xl px-4 py-12 text-muted-foreground">
      ...
      <p className="mt-2">ToolsHive respects your privacy. Most of our tools run entirely in your browser and do not upload your files or text to any server.</p>
