...
function TermsPage() {
  return (
    <article className="mx-auto max-w-3xl px-4 py-12 text-muted-foreground">
      ...
      <p className="mt-2">By using ToolHive, you agree to these terms. If you do not agree, please do not use the site.</p>
      ...
      <p className="mt-2">To the fullest extent permitted by law, ToolHive is not liable for any indirect, incidental, or consequential damages resulting from your use of the site.</p>
