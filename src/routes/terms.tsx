...
export const Route = createFileRoute("/terms")({
  head: () => ({ meta: [
    { title: "Terms of Service — ToolHarbor" },
    { name: "description", content: "Terms governing your use of the ToolHarbor website and tools." },
  ]}),
  component: TermsPage,
});
...
function TermsPage() {
  return (
    <article className="mx-auto max-w-3xl px-4 py-12 text-muted-foreground">
      ...
      <p className="mt-2">By using ToolHarbor, you agree to these terms. If you do not agree, please do not use the site.</p>
      ...
      <p className="mt-2">To the fullest extent permitted by law, ToolHarbor is not liable for any indirect, incidental, or consequential damages resulting from your use of the site.</p>
