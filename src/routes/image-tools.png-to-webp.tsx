...
export const Route = createFileRoute("/image-tools/png-to-webp")({
  head: () => toolHead("image-tools", "png-to-webp"),
  component: Page,
});
...
function Page() {
  ...
  return (
    <ToolShell categorySlug="image-tools" toolSlug="png-to-webp"
      intro="Convert PNG images to modern WebP format for smaller files. Conversion runs entirely in your browser — your image never leaves your device."
      howTo={["Choose or drop a PNG image.", "Click Convert.", "Download the WEBP result."]}
    >
