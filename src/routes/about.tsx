...
export const Route = createFileRoute("/about")({
  head: () => ({ meta: [
    ...
    { name: "description", content: "ToolsHive is a free suite of 55 online tools for text, images, PDFs, developers, calculators, and content creation." },
    { property: "og:title", content: "About ToolsHive — Free Online Tools" },
    { property: "og:description", content: "ToolsHive is a free suite of 55 online tools for text, images, PDFs, developers, calculators, and content creation." },
...
function AboutPage() {
  return (
    <article className="mx-auto max-w-3xl px-4 py-12">
      ...
      <p className="mt-4 text-muted-foreground">ToolsHive is a growing collection of 55 free online tools built for students, writers, marketers, creators, and developers. Our goal is simple: give everyone fast, reliable, no-signup utilities that respect their privacy.</p>
