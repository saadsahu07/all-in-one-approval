...
export const Route = createFileRoute("/about")({
  head: () => ({ meta: [
    ...
    { name: "description", content: "ToolHive is a free suite of 53 online tools for text, images, PDFs, developers, calculators, and content creation." },
  ]}),
  component: AboutPage,
});
...
function AboutPage() {
  return (
    <article className="mx-auto max-w-3xl px-4 py-12">
      ...
      <p className="mt-4 text-muted-foreground">ToolHive is a growing collection of 53 free online tools built for students, writers, marketers, creators, and developers. Our goal is simple: give everyone fast, reliable, no-signup utilities that respect their privacy.</p>
