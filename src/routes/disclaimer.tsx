...
function DisclaimerPage() {
  return (
    <article className="mx-auto max-w-3xl px-4 py-12 text-muted-foreground">
      ...
      <p className="mt-4">The information and tools on ToolsHive are provided for general informational and productivity purposes only. While we make every effort to ensure accuracy, we make no warranties of any kind, express or implied, about the completeness, accuracy, or reliability of any output.</p>
      ...
      <p className="mt-4">Any action you take based on information from this site is strictly at your own risk. ToolsHive is not liable for any losses or damages arising from your use of the tools.</p>
    </article>
  );
}