// AUTO-GENERATED SEO CONTENT — edit the source in tool-seo.ts to update.
// Each entry drives the tool page's <title>, meta description, canonical,
// body copy, features, and FAQPage schema. Keyed by full tool path.
...
export const toolSeo: Record<string, ToolSeo> = {
  ...
  "/content-creation/youtube-transcript-extractor": {
    title: "YouTube Transcript Extractor — Free Video Transcripts",
    metaDescription: "Extract the full transcript from any YouTube video with captions. Free, instant, no signup — copy the text for notes, blogs, or summaries.",
    keyword: "youtube transcript extractor",
    intro: [
      "Extract the full transcript from any YouTube video with captions in seconds. Paste a YouTube URL and get a clean, copy-ready text version — perfect for turning videos into notes, blog posts, or AI-ready source material.",
      "Ideal for students, researchers, content creators, and podcasters. Works with English captions on standard videos, Shorts, and live replays.",
    ],
    features: [
      "Extracts creator-uploaded or auto-generated captions",
      "Cleans out timestamps and HTML for a readable transcript",
      "One-click copy or download as .txt",
      "Supports youtube.com, youtu.be, and Shorts URLs",
    ],
    faqs: [
      { q: "Which videos work?", a: "Any public YouTube video that has captions — either uploaded by the creator or auto-generated by YouTube. Videos with captions disabled cannot be extracted." },
      { q: "How accurate are the transcripts?", a: "Creator-uploaded captions are usually near-perfect. Auto-generated captions are ~90–95% accurate and may miss punctuation or misinterpret names and technical terms." },
      { q: "Is this tool really free?", a: "Yes. The YouTube transcript extractor is 100% free with no signup, no watermark, and no daily limit for typical use." },
      { q: "Do I need an account?", a: "No. Nothing on ToolHive requires signup — open the tool and start using it immediately." },
    ],
  },
...
export function getToolSeo(path: string): ToolSeo | undefined {
  return toolSeo[path];
}